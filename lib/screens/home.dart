          ...
          Padding(
            ...
            child: Column(
              children: [
                  ...
                  child: Card(
                    ...
                    child: SizedBox(
                      child: Column(
                        children: [
                          ListTile(
                            title: Text("Shipment Number", style: fontStyle2c),
                            subtitle:
                                Text("NEJ20089934122231", style: fontStyle2),
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: ListTile(
                                      ...
                                      title: Text("Sender", style: fontStyle2c),
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListTile(
                                      title: Text("Time", style: fontStyle2c),
                                      subtitle: Row(
                                        children: [
                                          Icon(Icons.circle,
                                              size: 10,
                              ...
                              Row(
                                children: [
                                    ...
                                    child: ListTile(
                                      leading: CircleAvatar(
                                          ...
                                          backgroundImage: const AssetImage(
                                              "assets/icons/present.png")),
                                      title:
                                          Text("Receiver", style: fontStyle2c),
                                  ...
                                  SizedBox(
                                    width: size.width * 0.4,
                                    child: ListTile(
                                      title: Text("Status", style: fontStyle2c),
                                      subtitle: Text(
                                        "Waiting to collect",
                                        style: fontStyle2b,
                                      ),
                ...
                SizedBox(height: size.height * 0.01),
                ListTile(
                    leading: Text("Available Vehicles", style: fontStyle1b)),
              ],
            ),
          ),
        ],
